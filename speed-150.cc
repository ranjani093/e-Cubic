...
main (int argc, char *argv[])
{
 ...
 // bool tracing = true;
  ...
  std::string traceFile = "scratch/speed-150.ns_movements";
  uint32_t maxBytes = 0;
...
//  AnimationInterface anim("speed-150.xml");
...
// Enabling the XML Flow Monitor
 if (enableFlowMonitor)
    {
      flowmonHelper.SerializeToXmlFile ("speed-150.flowmon", false, false);
    }
  Simulator::Destroy ();
  return 0;
}
